...
public class SearchController {
    ...
    /**
     * MeiliSearch 클라이언트를 사용하여 SearchController의 인스턴스를 생성합니다.
     *
     * @param client MeiliSearch와의 통신에 사용할 클라이언트 인스턴스
     */
    ...
    /**
     * 인증된 사용자의 콘텐츠만 대상으로 MeiliSearch에서 검색을 수행합니다.
     *
     * @param request 검색 쿼리와 옵션이 포함된 요청 객체
     * @param auth 현재 인증된 사용자 정보
     * @return 사용자의 콘텐츠에 대한 MeiliSearch 검색 결과
