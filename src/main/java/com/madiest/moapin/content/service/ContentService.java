...
public class ContentService {
    ...
    @Transactional
    public Content createContent(Long categoryId, String type, String title, String body, String url, String fileKey) {
    ...
    public Content updateContent(Long contentId, String title, String body, String url) {
        User user = (User) SecurityContextHolder.getContext().getAuthentication().getPrincipal();
        Content content = contentRepository.findByIdAndUser(contentId, user)
    ...
    public Content getContent(Long contentId) {
        User user = (User) SecurityContextHolder.getContext().getAuthentication().getPrincipal();
        return contentRepository.findByIdAndUser(contentId, user)
                .orElseThrow(() -> new RuntimeException("Content not found"));
    }
