...
public class ContentController {
    ...
    public ResponseEntity<ContentResponse> createContent(@RequestBody ContentCreateRequest request) {
        Content content = contentService.createContent(request.getCategoryId(), request.getType(), request.getTitle(), request.getBody(), request.getUrl(), request.getFileKey());
    ...
    public ResponseEntity<ContentResponse> updateContent(@PathVariable Long contentId, @RequestBody ContentUpdateRequest request) {
        Content content = contentService.updateContent(contentId, request.getTitle(), request.getBody(), request.getUrl());
        return ResponseEntity.ok(ContentResponse.fromEntity(content));
    }
