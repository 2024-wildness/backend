...
- Naming: Classes PascalCase; methods/fields camelCase; constants UPPER_SNAKE_CASE; packages `com.madiest.moapin.<feature>`.
...
- REST: Spring MVC controllers under feature packages; validate requests with javax/jakarta validation; document via springdoc-openapi.
