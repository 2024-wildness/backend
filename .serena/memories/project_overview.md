...
Purpose
- Provide REST APIs for authentication, content (notes/links/photos), categories, reminders, search indexing, and share links.
...
Structure
- src/main/java: app code under packages `com.madiest.moapin.*` (auth, content, category, search, reminder, share, common/config)
